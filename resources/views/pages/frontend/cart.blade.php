                ...
                <div class="w-full md:px-4 md:w-4/12" id="shipping-detail">
                    <div class="bg-gray-100 px-4 py-6 md:p-8 md:rounded-3xl">
                        <form action="{{ route('checkout') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="flex flex-col mb-4">
                                <label for="desc" class="text-sm mb-2">Deskripsi / Ukuran</label>
                                <input data-input name="desc" type="text" id="desc"
                                    class="border-gray-200 border rounded-lg px-4 py-2 bg-white text-sm focus:border-blue-200 focus:outline-none"
                                    placeholder="Input your size" />
                            </div>
                            <div class="flex flex-col mb-4">
                                <label for="upload" class="text-sm mb-2">Upload Bukti</label>
                                <input data-input name="url" type="file" id="url"
                                    class="border-gray-200 border rounded-lg px-4 py-2 bg-white text-sm focus:border-blue-200 focus:outline-none"
                                    placeholder="Input your size" />
                            </div>
